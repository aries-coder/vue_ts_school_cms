...
export const currentDatatableColumnsConfig: DataTableColumns = [
  {
    title: '序号',
    key: 'sort',
    align: 'center'
...
export const initiaTableRowFn = (listInfo: any[]) => {
  ...
  console.log(rowListInfo)

  return rowListInfo
}

export const initiaCurrentTeachingCourseInfo = (
  currentInfo: any[],
  fn: Function
) => {
  const currentListInfo: ITableRowType[] = []
  console.log(currentInfo, 'dsdsdsdsdsds')
